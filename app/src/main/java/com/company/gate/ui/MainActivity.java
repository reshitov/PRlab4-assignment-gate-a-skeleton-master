...
import com.company.gate.R;

import com.company.gate.logic.Logic;
import com.company.gate.logic.LogicInterface;
...
public class MainActivity
     ...
     * Logic Instance.
     */
    private LogicInterface mLogic;      //mainActivity вызывает метод
    ...
    public void buttonPressed(View buttonPress) {
        resetText();
        mLogic.process(); //вызывается в mainActivity
    }
